...
export const MODELOS: Modelo[] = [
  ...
  },
  {
    id: "almendra",
    nombre: "Almendra",
    descripcion: "Cuello alto en pico, bolsillo de pecho y pantalón de pretina elástica. Cómodo para toda la jornada.",
    escote: "alto-pico",
    manga: "kimono",
    pantalon: "recto",
    disponibilidad: "bajo-pedido",
    detalles: ["Cuello alto en pico", "Bolsillo de parche en el pecho", "Pretina elástica fruncida"],
    foto: { src: "/modelos/almendra.webp", ancho: 389, alto: 850 },
